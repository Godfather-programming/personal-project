const servicesIcons = [
  {
    ...
    title: "Web Design",
    text: "Lipsum as it is sometimes known is dummy text used in laying out print, graphic or web designs.",
    bgColor: "#8540FF",
    shapeColor: "#803AFB",
    shadowColor: "#760DFF35",
  },
  {
    key: 2,
    svg: (
